...
const PlacementTestEvergreen = () => {
  return (
    <div className="flex flex-col gap-xl items-center w-full max-w-4xl mx-auto py-xl px-md">
      ...
      <div className="w-full grid grid-cols-1 md:grid-cols-12 gap-xl relative">
        <div className="hidden xl:block absolute -left-20 top-0 text-secondary opacity-50 select-none">
        ...
        <div className="md:col-span-12 bg-surface chunky-border chunky-shadow p-md inner-highlight flex flex-col gap-md">
          <label className="font-label-sm text-label-sm text-on-surface-variant uppercase" htmlFor="translation-input">Your Translation</label>
...
export default PlacementTestEvergreen;
