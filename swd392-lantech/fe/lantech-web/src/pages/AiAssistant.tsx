...
<div className="w-full md:w-1/3 flex flex-col items-center gap-md sticky top-[120px]">
...
<img alt="Owl Mascot" className="w-full h-full object-cover rounded-full" data-alt="A charming, stylized illustration of a wise owl perched on a sturdy wooden branch, surrounded by subtle glowing magical particles. The art style mimics 16-bit pixel art or classic cottagecore illustrations, with rich browns, soft creams, and vibrant leafy greens. The owl looks friendly and knowledgeable." src="https://lh3.googleusercontent.com/aida-public/AB6AXuCUFuImg02CfrRsLywBRvjHfa-tyu-wByq4W9mCl4nRbVjlwXMmjy7iBvybMuHoLTPYK9hENg33K63TP_NtbUmwPUK3R0M0Y-JJ2TPij6UfahuNQNMT0u-ul7ixGdwvDriv3kiC1gsh8zRJ0epVTzX_l2N1RP9BNKMGghLYWLeWlk3ePbDtklDJPiJaIE7-4UCthsZ-LfJB9PedVno3cBbaGRpfK7iKgk9EhrN5gtjzFEnOLNB3q9ilTVGhV6MpNQdibQF-dsneKA"/>
</div>
<div className="chunky-card bg-surface-container p-sm text-center">
...
<div className="w-full md:w-2/3 flex flex-col h-[716px] min-h-[500px]">
